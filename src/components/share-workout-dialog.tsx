    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col h-full p-4">
                ...
                {/* Header */}
                <div className="flex-none relative z-30 mb-2">
                ...
                {/* Stats Grid */}
                <div className="grid grid-cols-2 gap-2 mb-2 flex-none mt-2">
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                ...
                <div className="flex justify-center p-2" id="share-card-container">
                    {/* Visible Instance: Wrapped in aspect ratio container to look like the card */}
                    <div className="w-full max-w-[320px] aspect-[9/15] mx-auto shadow-2xl rounded-3xl overflow-hidden">
