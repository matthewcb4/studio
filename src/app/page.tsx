...
export default function LoginPage() {
  ...
  return (
    <div className="w-full lg:grid lg:min-h-screen lg:grid-cols-2 xl:min-h-screen">
      <div className="flex items-center justify-center py-12 px-6 min-h-screen lg:min-h-0 relative overflow-hidden">
        ...
        <div className="mx-auto grid w-full max-w-[350px] gap-6 z-10">
